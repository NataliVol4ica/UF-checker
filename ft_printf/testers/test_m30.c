...
//@
	...
	ret1 = fprintf(printf_, "|%10.0hhs|\n", L"casual string");
	ret2 = ft_printf("|%10.0hhs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0001");
	fprintf(printf_, "#0001");
	ret1 = fprintf(printf_, "|%10.0hs|\n", L"casual string");
	ret2 = ft_printf("|%10.0hs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0002");
	fprintf(printf_, "#0002");
	ret1 = fprintf(printf_, "|%10.0ls|\n", L"casual string");
	ret2 = ft_printf("|%10.0ls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0003");
	fprintf(printf_, "#0003");
	ret1 = fprintf(printf_, "|%10.0lls|\n", L"casual string");
	ret2 = ft_printf("|%10.0lls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0004");
	fprintf(printf_, "#0004");
	ret1 = fprintf(printf_, "|%10.0js|\n", L"casual string");
	ret2 = ft_printf("|%10.0js|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0005");
	fprintf(printf_, "#0005");
	ret1 = fprintf(printf_, "|%10.0zs|\n", L"casual string");
	ret2 = ft_printf("|%10.0zs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0006");
...
//@
	...
	ret1 = fprintf(printf_, "|%010.0hhs|\n", L"casual string");
	ret2 = ft_printf("|%010.0hhs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0025");
	fprintf(printf_, "#0025");
	ret1 = fprintf(printf_, "|%010.0hs|\n", L"casual string");
	ret2 = ft_printf("|%010.0hs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0026");
	fprintf(printf_, "#0026");
	ret1 = fprintf(printf_, "|%010.0ls|\n", L"casual string");
	ret2 = ft_printf("|%010.0ls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0027");
	fprintf(printf_, "#0027");
	ret1 = fprintf(printf_, "|%010.0lls|\n", L"casual string");
	ret2 = ft_printf("|%010.0lls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0028");
	fprintf(printf_, "#0028");
	ret1 = fprintf(printf_, "|%010.0js|\n", L"casual string");
	ret2 = ft_printf("|%010.0js|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0029");
	fprintf(printf_, "#0029");
	ret1 = fprintf(printf_, "|%010.0zs|\n", L"casual string");
	ret2 = ft_printf("|%010.0zs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0030");
...
//@
	...
	ret1 = fprintf(printf_, "|%0+10.0hhs|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0hhs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0073");
	fprintf(printf_, "#0073");
	ret1 = fprintf(printf_, "|%0+10.0hs|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0hs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0074");
	fprintf(printf_, "#0074");
	ret1 = fprintf(printf_, "|%0+10.0ls|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0ls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0075");
	fprintf(printf_, "#0075");
	ret1 = fprintf(printf_, "|%0+10.0lls|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0lls|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0076");
	fprintf(printf_, "#0076");
	ret1 = fprintf(printf_, "|%0+10.0js|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0js|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0077");
	fprintf(printf_, "#0077");
	ret1 = fprintf(printf_, "|%0+10.0zs|\n", L"casual string");
	ret2 = ft_printf("|%0+10.0zs|\n", L"casual string");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0078");
