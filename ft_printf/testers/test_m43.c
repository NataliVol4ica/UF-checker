...
int		main(void)
{
	...
	printf_ = fopen("../files/test_m43_printf_print", "w");
	printf_ret = fopen("../files/test_m43_printf_ret", "w");
	ft_printf_ret = fopen("../files/test_m43_ft_printf_ret", "w");
...
//@
	...
	ret1 = fprintf(printf_, "|%4.3hhD|\n");
	ret2 = ft_printf("|%4.3hhD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0001");
	fprintf(printf_, "#0001");
	ret1 = fprintf(printf_, "|%4.3hD|\n");
	ret2 = ft_printf("|%4.3hD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0002");
	fprintf(printf_, "#0002");
	ret1 = fprintf(printf_, "|%4.3lD|\n");
	ret2 = ft_printf("|%4.3lD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0003");
	fprintf(printf_, "#0003");
	ret1 = fprintf(printf_, "|%4.3llD|\n");
	ret2 = ft_printf("|%4.3llD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0004");
	fprintf(printf_, "#0004");
	ret1 = fprintf(printf_, "|%4.3jD|\n");
	ret2 = ft_printf("|%4.3jD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0005");
	fprintf(printf_, "#0005");
	ret1 = fprintf(printf_, "|%4.3zD|\n");
	ret2 = ft_printf("|%4.3zD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0006");
	fprintf(printf_, "#0006");
	ret1 = fprintf(printf_, "|%4.3hhO|\n");
	ret2 = ft_printf("|%4.3hhO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0007");
	fprintf(printf_, "#0007");
	ret1 = fprintf(printf_, "|%4.3hO|\n");
	ret2 = ft_printf("|%4.3hO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0008");
	fprintf(printf_, "#0008");
	ret1 = fprintf(printf_, "|%4.3lO|\n");
	ret2 = ft_printf("|%4.3lO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0009");
	fprintf(printf_, "#0009");
	ret1 = fprintf(printf_, "|%4.3llO|\n");
	ret2 = ft_printf("|%4.3llO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0010");
	fprintf(printf_, "#0010");
	ret1 = fprintf(printf_, "|%4.3jO|\n");
	ret2 = ft_printf("|%4.3jO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0011");
	fprintf(printf_, "#0011");
	ret1 = fprintf(printf_, "|%4.3zO|\n");
	ret2 = ft_printf("|%4.3zO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0012");
	fprintf(printf_, "#0012");
	ret1 = fprintf(printf_, "|%4.3hhU|\n");
	ret2 = ft_printf("|%4.3hhU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0013");
	fprintf(printf_, "#0013");
	ret1 = fprintf(printf_, "|%4.3hU|\n");
	ret2 = ft_printf("|%4.3hU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0014");
	fprintf(printf_, "#0014");
	ret1 = fprintf(printf_, "|%4.3lU|\n");
	ret2 = ft_printf("|%4.3lU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0015");
	fprintf(printf_, "#0015");
	ret1 = fprintf(printf_, "|%4.3llU|\n");
	ret2 = ft_printf("|%4.3llU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0016");
	fprintf(printf_, "#0016");
	ret1 = fprintf(printf_, "|%4.3jU|\n");
	ret2 = ft_printf("|%4.3jU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0017");
	fprintf(printf_, "#0017");
	ret1 = fprintf(printf_, "|%4.3zU|\n");
	ret2 = ft_printf("|%4.3zU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0018");
...
//@
	...
	ret1 = fprintf(printf_, "|%04.3hhD|\n");
	ret2 = ft_printf("|%04.3hhD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0037");
	fprintf(printf_, "#0037");
	ret1 = fprintf(printf_, "|%04.3hD|\n");
	ret2 = ft_printf("|%04.3hD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0038");
	fprintf(printf_, "#0038");
	ret1 = fprintf(printf_, "|%04.3lD|\n");
	ret2 = ft_printf("|%04.3lD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0039");
	fprintf(printf_, "#0039");
	ret1 = fprintf(printf_, "|%04.3llD|\n");
	ret2 = ft_printf("|%04.3llD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0040");
	fprintf(printf_, "#0040");
	ret1 = fprintf(printf_, "|%04.3jD|\n");
	ret2 = ft_printf("|%04.3jD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0041");
	fprintf(printf_, "#0041");
	ret1 = fprintf(printf_, "|%04.3zD|\n");
	ret2 = ft_printf("|%04.3zD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0042");
	fprintf(printf_, "#0042");
	ret1 = fprintf(printf_, "|%04.3hhO|\n");
	ret2 = ft_printf("|%04.3hhO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0043");
	fprintf(printf_, "#0043");
	ret1 = fprintf(printf_, "|%04.3hO|\n");
	ret2 = ft_printf("|%04.3hO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0044");
	fprintf(printf_, "#0044");
	ret1 = fprintf(printf_, "|%04.3lO|\n");
	ret2 = ft_printf("|%04.3lO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0045");
	fprintf(printf_, "#0045");
	ret1 = fprintf(printf_, "|%04.3llO|\n");
	ret2 = ft_printf("|%04.3llO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0046");
	fprintf(printf_, "#0046");
	ret1 = fprintf(printf_, "|%04.3jO|\n");
	ret2 = ft_printf("|%04.3jO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0047");
	fprintf(printf_, "#0047");
	ret1 = fprintf(printf_, "|%04.3zO|\n");
	ret2 = ft_printf("|%04.3zO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0048");
	fprintf(printf_, "#0048");
	ret1 = fprintf(printf_, "|%04.3hhU|\n");
	ret2 = ft_printf("|%04.3hhU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0049");
	fprintf(printf_, "#0049");
	ret1 = fprintf(printf_, "|%04.3hU|\n");
	ret2 = ft_printf("|%04.3hU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0050");
	fprintf(printf_, "#0050");
	ret1 = fprintf(printf_, "|%04.3lU|\n");
	ret2 = ft_printf("|%04.3lU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0051");
	fprintf(printf_, "#0051");
	ret1 = fprintf(printf_, "|%04.3llU|\n");
	ret2 = ft_printf("|%04.3llU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0052");
	fprintf(printf_, "#0052");
	ret1 = fprintf(printf_, "|%04.3jU|\n");
	ret2 = ft_printf("|%04.3jU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0053");
	fprintf(printf_, "#0053");
	ret1 = fprintf(printf_, "|%04.3zU|\n");
	ret2 = ft_printf("|%04.3zU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0054");
...
//@
	...
	ret1 = fprintf(printf_, "|%0+4.3hhD|\n");
	ret2 = ft_printf("|%0+4.3hhD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0109");
	fprintf(printf_, "#0109");
	ret1 = fprintf(printf_, "|%0+4.3hD|\n");
	ret2 = ft_printf("|%0+4.3hD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0110");
	fprintf(printf_, "#0110");
	ret1 = fprintf(printf_, "|%0+4.3lD|\n");
	ret2 = ft_printf("|%0+4.3lD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0111");
	fprintf(printf_, "#0111");
	ret1 = fprintf(printf_, "|%0+4.3llD|\n");
	ret2 = ft_printf("|%0+4.3llD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0112");
	fprintf(printf_, "#0112");
	ret1 = fprintf(printf_, "|%0+4.3jD|\n");
	ret2 = ft_printf("|%0+4.3jD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0113");
	fprintf(printf_, "#0113");
	ret1 = fprintf(printf_, "|%0+4.3zD|\n");
	ret2 = ft_printf("|%0+4.3zD|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0114");
	fprintf(printf_, "#0114");
	ret1 = fprintf(printf_, "|%0+4.3hhO|\n");
	ret2 = ft_printf("|%0+4.3hhO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0115");
	fprintf(printf_, "#0115");
	ret1 = fprintf(printf_, "|%0+4.3hO|\n");
	ret2 = ft_printf("|%0+4.3hO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0116");
	fprintf(printf_, "#0116");
	ret1 = fprintf(printf_, "|%0+4.3lO|\n");
	ret2 = ft_printf("|%0+4.3lO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0117");
	fprintf(printf_, "#0117");
	ret1 = fprintf(printf_, "|%0+4.3llO|\n");
	ret2 = ft_printf("|%0+4.3llO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0118");
	fprintf(printf_, "#0118");
	ret1 = fprintf(printf_, "|%0+4.3jO|\n");
	ret2 = ft_printf("|%0+4.3jO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0119");
	fprintf(printf_, "#0119");
	ret1 = fprintf(printf_, "|%0+4.3zO|\n");
	ret2 = ft_printf("|%0+4.3zO|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0120");
	fprintf(printf_, "#0120");
	ret1 = fprintf(printf_, "|%0+4.3hhU|\n");
	ret2 = ft_printf("|%0+4.3hhU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0121");
	fprintf(printf_, "#0121");
	ret1 = fprintf(printf_, "|%0+4.3hU|\n");
	ret2 = ft_printf("|%0+4.3hU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0122");
	fprintf(printf_, "#0122");
	ret1 = fprintf(printf_, "|%0+4.3lU|\n");
	ret2 = ft_printf("|%0+4.3lU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0123");
	fprintf(printf_, "#0123");
	ret1 = fprintf(printf_, "|%0+4.3llU|\n");
	ret2 = ft_printf("|%0+4.3llU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0124");
	fprintf(printf_, "#0124");
	ret1 = fprintf(printf_, "|%0+4.3jU|\n");
	ret2 = ft_printf("|%0+4.3jU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0125");
	fprintf(printf_, "#0125");
	ret1 = fprintf(printf_, "|%0+4.3zU|\n");
	ret2 = ft_printf("|%0+4.3zU|\n");
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0126");
