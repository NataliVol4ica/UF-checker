...
//@
	...
	ret1 = fprintf(printf_, "|%02hhc|\n", L'α');
	ret2 = ft_printf("|%02hhc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0025");
	fprintf(printf_, "#0025");
	ret1 = fprintf(printf_, "|%02hc|\n", L'α');
	ret2 = ft_printf("|%02hc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
...
//@
	...
	ret1 = fprintf(printf_, "|%02llc|\n", L'α');
	ret2 = ft_printf("|%02llc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0028");
	fprintf(printf_, "#0028");
	ret1 = fprintf(printf_, "|%02jc|\n", L'α');
	ret2 = ft_printf("|%02jc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
...
//@
	...
	ret1 = fprintf(printf_, "|%0+2hhc|\n", L'α');
	ret2 = ft_printf("|%0+2hhc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0073");
	fprintf(printf_, "#0073");
	ret1 = fprintf(printf_, "|%0+2hc|\n", L'α');
	ret2 = ft_printf("|%0+2hc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0074");
	fprintf(printf_, "#0074");
	ret1 = fprintf(printf_, "|%0+2lc|\n", L'α');
	ret2 = ft_printf("|%0+2lc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0075");
	fprintf(printf_, "#0075");
	ret1 = fprintf(printf_, "|%0+2llc|\n", L'α');
	ret2 = ft_printf("|%0+2llc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0076");
	fprintf(printf_, "#0076");
	ret1 = fprintf(printf_, "|%0+2jc|\n", L'α');
	ret2 = ft_printf("|%0+2jc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0077");
	fprintf(printf_, "#0077");
	ret1 = fprintf(printf_, "|%0+2zc|\n", L'α');
	ret2 = ft_printf("|%0+2zc|\n", L'α');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0078");
