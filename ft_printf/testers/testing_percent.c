...
size_t testing_percent_tests = 112;

void		testing_percent(int width, int precision, int var)
{
	int		ret1;
	int		ret2;
	char	*loc;
	...
	fprintf(fppres, "NAME = testing_percent.c\n");
	...
	ft_printf("===\\ NEW TEST\n");
	ft_printf("NAME = testing_percent.c\n");
	ft_printf("TESTS = %zu\n", testing_percent_tests);
	ft_printf("WIDTH = %d\n", width);
