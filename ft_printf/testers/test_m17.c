...
//@
	...
	ret1 = fprintf(printf_, "|%0.llc|\n", L'V');
	ret2 = ft_printf("|%0.llc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0004");
	fprintf(printf_, "#0004");
	ret1 = fprintf(printf_, "|%0.jc|\n", L'V');
	ret2 = ft_printf("|%0.jc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
...
//@
	...
	ret1 = fprintf(printf_, "|%00.hhc|\n", L'V');
	ret2 = ft_printf("|%00.hhc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0025");
	fprintf(printf_, "#0025");
	ret1 = fprintf(printf_, "|%00.hc|\n", L'V');
	ret2 = ft_printf("|%00.hc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0026");
	fprintf(printf_, "#0026");
	ret1 = fprintf(printf_, "|%00.lc|\n", L'V');
	ret2 = ft_printf("|%00.lc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0027");
	fprintf(printf_, "#0027");
	ret1 = fprintf(printf_, "|%00.llc|\n", L'V');
	ret2 = ft_printf("|%00.llc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0028");
	fprintf(printf_, "#0028");
	ret1 = fprintf(printf_, "|%00.jc|\n", L'V');
	ret2 = ft_printf("|%00.jc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0029");
	fprintf(printf_, "#0029");
	ret1 = fprintf(printf_, "|%00.zc|\n", L'V');
	ret2 = ft_printf("|%00.zc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0030");
...
//@
	...
	ret1 = fprintf(printf_, "|%0+0.hhc|\n", L'V');
	ret2 = ft_printf("|%0+0.hhc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0073");
	fprintf(printf_, "#0073");
	ret1 = fprintf(printf_, "|%0+0.hc|\n", L'V');
	ret2 = ft_printf("|%0+0.hc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0074");
	fprintf(printf_, "#0074");
	ret1 = fprintf(printf_, "|%0+0.lc|\n", L'V');
	ret2 = ft_printf("|%0+0.lc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0075");
	fprintf(printf_, "#0075");
	ret1 = fprintf(printf_, "|%0+0.llc|\n", L'V');
	ret2 = ft_printf("|%0+0.llc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0076");
	fprintf(printf_, "#0076");
	ret1 = fprintf(printf_, "|%0+0.jc|\n", L'V');
	ret2 = ft_printf("|%0+0.jc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0077");
	fprintf(printf_, "#0077");
	ret1 = fprintf(printf_, "|%0+0.zc|\n", L'V');
	ret2 = ft_printf("|%0+0.zc|\n", L'V');
	fprintf(printf_ret, "%d", ret1);
	fprintf(ft_printf_ret, "%d", ret2);
//@
	ft_printf("#0078");
