...
size_t testing_apostrophe_sbs_tests = 576;

void		testing_apostrophe_sbs(int width, int precision, wchar_t *var)
{
	int		ret1;
	int		ret2;
	char	*loc;
	...
	fprintf(fppres, "NAME = testing_apostrophe_sbs.c\n");
	fprintf(fppres, "TESTS = %zu\n", testing_apostrophe_sbs_tests);
	...
	ft_printf("===\\ NEW TEST\n");
	ft_printf("NAME = testing_apostrophe_sbs.c\n");
	ft_printf("TESTS = %zu\n", testing_apostrophe_sbs_tests);
	ft_printf("WIDTH = %d\n", width);
	...
	//@
	fprintf(fppres, "#0008");
	ret1 = fprintf(fppres, "|%'*.*ts|\n", width, precision, var);
	ret1 > -1 ? ft_printf("#0008") : 1;
	ret2 = ret1 > -1 ? ft_printf("|%'*.*ts|\n", width, precision, var) : -1;
	fprintf(fppret, "%d\n", ret1);
	fprintf(fpftret, "%d\n", ret2);
	//@
	fprintf(fppres, "#0009");
	...
	//@
	fprintf(fppres, "#0026");
	ret1 = fprintf(fppres, "|%0'*.*ts|\n", width, precision, var);
	ret1 > -1 ? ft_printf("#0026") : 1;
	ret2 = ret1 > -1 ? ft_printf("|%0'*.*ts|\n", width, precision, var) : -1;
	fprintf(fppret, "%d\n", ret1);
	fprintf(fpftret, "%d\n", ret2);
	//@
	fprintf(fppres, "#0027");
